...
public class Array {
  ...
  /**
   * 1.Genera un array de tamaño n con números aleatorios cuyo intervalo (mínimo y
  ...
  /**
   * 6.Devuelve la posición de un número, n, dentro de un array de número enteros,
   * si el número no está en el array devuelve -1.
   *
   * @param n número entero buscado
